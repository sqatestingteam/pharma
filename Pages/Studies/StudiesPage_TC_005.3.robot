...
Check Basic Information edit option
    ...
    click element   ${Basic_Information_Edit_Icon}
    Element Should Be Visible   ${Barcode_Input_Box}
    Element Should Be Visible   ${Time_Created_Input_Box}
    Element Should Be Visible   ${Update_Button}
